...
fun Scale(
    ...
    minWeight: Int = 20, // minimum weight in the picker
    maxWeight: Int = 150, // max weight in the picker
    initialWeight: Int = 80, // the first weight of the picker
    ...
    // center of the circle (weight picker)
